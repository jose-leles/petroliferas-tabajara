	...
	return (
		<>
			...
			<Container fullSize={true}>
				<div
					class="flex bg-opacity-5 bg-cover"
				...
				>
					<div class="flex flex-col items-center bg-gray-300 px-96 py-60 bg-opacity-80 w-full">
						...
						<button
							class="mt-7 bg-yellow-500 hover:bg-yellow-700 text-white text-base font-bold py-3 px-4 rounded w-60"
							onClick={() => {
								setMostraModal(true)
							}}
						>
				...
				<div
					id="sobre"
					class="flex flex-col items-center px-96 py-60 bg-opacity-80 w-full"
				>
